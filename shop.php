...
<header>
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item active" style="background-image: url('https://media.gemini.media/img/large/2019/3/21/2019_3_21_16_39_45_523.jpg')">
      ...
      <div class="carousel-item" style="background-image: url('https://cdn.mosoah.com/wp-content/uploads/2020/01/27144246/%D9%85%D8%B3%D8%AA%D8%AD%D8%B6%D8%B1%D8%A7%D8%AA-%D8%A7%D9%84%D8%AA%D8%AC%D9%85%D9%8A%D9%84-825x510.jpeg')">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item" style="background-image: url('https://i0.wp.com/www.aromaticglance.com/wp-content/uploads/2020/08/fragrance-day_1200x672_acf_cropped.jpg?fit=1200%2C672&ssl=1')">
        <div class="carousel-caption d-none d-md-block">
...
<div class="container mt-4">
  ...
  <?php 
            ...
            <img class="img-fluid h-100 w-100" src="./image_prod/<?php echo $data['Product_Picture']?>" alt="">
          </div>
    <?php  }  ?>
    <div class="card-body">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-0 shadow">
        <img src="./image_user/<?php echo $data['Product_Picture']?>" class="card-img-top" alt="...">
        <div class="card-body text-center">
          <h5 class="card-title mb-0">Team Member</h5>
          <div class="card-text text-black-50">Web Developer</div>
        </div>
